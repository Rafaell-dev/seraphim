...
exports.getTransactionByIdController = exports.getByIdValidation = void 0;
...
var getTransactionByIdController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var traId, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                traId = req.params.tra_id;
                if (!traId) {
                    return [2 /*return*/, res
            ...
            case 2:
                ...
                return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.OK).json(result)];
            case 3:
                error_1 = _a.sent();
                console.error('Error getting transaction:', error_1);
                return [2 /*return*/, res
