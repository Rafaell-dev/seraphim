...
exports.createTransactionController = exports.createValidation = void 0;
var yup = __importStar(require("yup"));
var middleware_1 = require("../../shared/middleware");
var http_status_codes_1 = require("http-status-codes");
var create_1 = require("../../database/providers/transaction/create");
...
var createTransactionController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, create_1.createTransaction)(req.body)];
            case 1:
                result = _a.sent();
