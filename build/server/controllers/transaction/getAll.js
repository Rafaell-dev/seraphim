...
exports.getAllTransactionsController = exports.getAllValidation = void 0;
var yup = __importStar(require("yup"));
var middleware_1 = require("../../shared/middleware");
var http_status_codes_1 = require("http-status-codes");
var getAll_1 = require("../../database/providers/transaction/getAll");
...
var getAllTransactionsController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, getAll_1.getAllTransactions)(req.query.page || 1, req.query.limit || 10, req.query.filter || '', Number(req.query.tra_id) || 0)];
            case 1:
                result = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error getting transactions:', error_1);
                return [2 /*return*/, res
                        .status(http_status_codes_1.StatusCodes.INTERNAL_SERVER_ERROR)
