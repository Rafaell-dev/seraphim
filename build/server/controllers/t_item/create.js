...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var checkTransaction, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, providers_1.t_itemProvider.getTransactionItemById(req.body.t_item_tra_id)];
            case 1:
                checkTransaction = _a.sent();
                if (!checkTransaction) {
                    return [2 /*return*/, res
                            .status(http_status_codes_1.StatusCodes.BAD_REQUEST)
                            .json({ error: 'Invalid request, transaction not found' })];
                }
                return [4 /*yield*/, providers_1.t_itemProvider.createTransactionItem(req.body)];
            case 2:
                result = _a.sent();
                return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.CREATED).send(result)];
            case 3:
                error_1 = _a.sent();
                console.error('Error creating transaction item:', error_1);
                return [2 /*return*/, res
