...
var updateById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var t_item_tra_id, existingTransaction, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                t_item_tra_id = req.body.t_item_tra_id;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, providers_1.transactionProvider.getTransactionById(t_item_tra_id)];
            case 2:
                ...
                return [4 /*yield*/, providers_1.t_itemProvider.updateTransactionItemById(req.body)];
            case 3:
                result = _a.sent();
