...
exports.deleteByIdValidation = (0, middleware_1.validation)(function (getSchema) { return ({
...
var deleteById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var checkTItem, t_itemId, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!req.body.t_item_id) {
                    return [2 /*return*/, res.status(http_status_codes_1.StatusCodes.BAD_REQUEST).send('Id is required')];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, providers_1.t_itemProvider.getTransactionItemById(req.body.t_item_id)];
            case 2:
                checkTItem = _a.sent();
                if (!checkTItem) {
                    return [2 /*return*/, res
                ...
                t_itemId = req.body.t_item_id;
                return [4 /*yield*/, providers_1.t_itemProvider.deleteTransactionItemById(t_itemId)];
            case 3:
                _a.sent();
                return [2 /*return*/, res.sendStatus(http_status_codes_1.StatusCodes.NO_CONTENT)];
            case 4:
                error_1 = _a.sent();
                console.log('Error deleting item:', error_1);
                return [2 /*return*/, res
