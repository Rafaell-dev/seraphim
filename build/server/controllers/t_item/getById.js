...
var getById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var t_item_id, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                t_item_id = req.params.t_item_id;
                return [4 /*yield*/, providers_1.t_itemProvider.getTransactionItemById(Number(t_item_id))];
            case 1:
                result = _a.sent();
                if (!result) {
                    return [2 /*return*/, res
            ...
            case 2:
                error_1 = _a.sent();
                console.error('Error getting item:', error_1);
                return [2 /*return*/, res
