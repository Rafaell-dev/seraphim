...
var updateById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ser_id, existingService, result, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ser_id = req.body.ser_id.ser_id;
                if (!ser_id) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, providers_1.serviceProvider.getServiceById(ser_id)];
            case 2:
                ...
                return [4 /*yield*/, providers_1.serviceProvider.updateServiceById(req.body)];
            case 3:
                result = _a.sent();
