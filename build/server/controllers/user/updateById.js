...
exports.updateUserByIdController = exports.updateByIdValidation = void 0;
var http_status_codes_1 = require("http-status-codes");
var yup = __importStar(require("yup"));
var middleware_1 = require("../../shared/middleware");
var updateById_1 = require("../../database/providers/user/updateById");
var getByEmail_1 = __importDefault(require("../../database/providers/user/getByEmail"));
...
var updateUserByIdController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, checkEmail, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, (0, getByEmail_1.default)(req.body.user_email)];
            case 2:
                checkEmail = _a.sent();
                ...
                return [4 /*yield*/, (0, updateById_1.updateUserById)(req.body)];
            case 3:
                result = _a.sent();
