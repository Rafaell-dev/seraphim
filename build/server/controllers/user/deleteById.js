...
exports.deleteUserByIdController = exports.deleteByIdValidation = void 0;
var http_status_codes_1 = require("http-status-codes");
var yup = __importStar(require("yup"));
var middleware_1 = require("../../shared/middleware");
var deleteById_1 = require("../../database/providers/user/deleteById");
...
var deleteUserByIdController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, deleteById_1.deleteUserById)(userId)];
            case 2:
                _a.sent();
